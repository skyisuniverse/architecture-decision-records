    ...
    return(
        <Box>
            <Typography variant="h4" sx={{ marginBottom: 2 }}>
                Reduction of data movement, latency & power use compared to GPUs
            </Typography>
            ...
            <Typography variant="body1" gutterBottom>
                ...
                number generation in probabilistic algorithms. This <b>reduces data movement, cutting 
                latency and power use</b> by factors like 10-100x <b>compared to GPUs</b>. For example, 
