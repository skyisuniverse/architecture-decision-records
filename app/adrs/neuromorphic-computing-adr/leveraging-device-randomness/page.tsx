    ...
    return(
        <Box>
            <Typography variant="h4" sx={{ marginBottom: 2 }}>
                Leveraging device randomness for efficient random number generation in probabilistic algorithms
            </Typography>
            ...
            <Typography variant="body1" gutterBottom>
                ...
                core operation in AI training—while <b>leveraging device randomness for efficient 
                random number generation in probabilistic algorithms</b>. This reduces data movement, 
