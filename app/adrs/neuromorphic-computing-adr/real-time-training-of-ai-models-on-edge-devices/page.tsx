    ...
    return(
        <Box>
            <Typography variant="h4" sx={{ marginBottom: 2 }}>
                Real-time training of AI models on edge devices
            </Typography>
            ...
            <Typography variant="body1" gutterBottom>
                ...
                core operation in AI training—while leveraging device randomness for efficient random 
                ...
                matter in the brain). Future breakthroughs here could allow AI models to <b>train in 
                real-time on edge devices</b>, making the process faster and more accessible without 
