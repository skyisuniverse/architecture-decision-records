...
export default async function Page() {
    ...
    <Box>
        <Typography variant="h4" sx={{ marginBottom: 2 }}>
            Pre-processing data for classical ML with quantum processors
        </Typography>
        ...
        <Typography variant="body1" gutterBottom>
            ...
            approaches, where <b>quantum processors pre-process data for classical ML</b>, have shown promise in reducing 
