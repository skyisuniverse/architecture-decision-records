...
export default async function Page() {
    ...
    <Box>
        <Typography variant="h4" sx={{ marginBottom: 2 }}>
            Fine-tuning models faster than classical methods
        </Typography>
        ...
        <Typography variant="body1" gutterBottom>
            ...
            Approximate Optimization (QAOA) or Variational Quantum Eigensolvers (VQE) might <b>fine-tune models 
            faster than classical methods</b>, potentially handling exponentially larger datasets. Hybrid quantum-AI 
