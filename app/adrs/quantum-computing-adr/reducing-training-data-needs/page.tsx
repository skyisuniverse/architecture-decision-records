...
export default async function Page() {
    ...
    <Box>
        <Typography variant="h4" sx={{ marginBottom: 2 }}>
            Reducing training data needs and speeding up convergence with quantum processors
        </Typography>
        ...
        <Typography variant="body1" gutterBottom>
            ...
            approaches, where <b>quantum processors</b> pre-process data for classical ML, have shown promise in <b>reducing 
            training data needs and speeding up convergence</b>. While current noisy intermediate-scale quantum (NISQ) 
            devices limit scale, fault-tolerant quantum computers could provide exponential speedups for tasks like 
            gradient descent, making training easier for problems intractable on classical hardware.
        </Typography>
    </Box>
