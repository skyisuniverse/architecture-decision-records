    ...
    return(
        <Box>
            <Typography variant="h4" sx={{ marginBottom: 2 }}>
                Using less energy and fewer operations than electronic equivalents for AI
            </Typography>
            ...
            <Typography variant="body1" gutterBottom>
                ...
                demonstrated over 97% accuracy on classification tasks while <b>using far less energy and fewer operations 
                than electronic equivalents</b> — potentially reducing AI data center power consumption by orders of magnitude 
