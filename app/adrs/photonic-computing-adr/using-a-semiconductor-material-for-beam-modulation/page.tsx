    ...
    return(
        <Box>
            <Typography variant="h4" sx={{ marginBottom: 2 }}>
                Using a semiconductor material for beam modulation
            </Typography>
            ...
            <Typography variant="body1" gutterBottom>
                ...
                capable of training nonlinear neural networks directly with light. This works by <b>using a semiconductor 
                material</b> where a "pump" <b>beam modulates</b> a "signal" beam's behavior (absorption, transmission, or amplification), 
