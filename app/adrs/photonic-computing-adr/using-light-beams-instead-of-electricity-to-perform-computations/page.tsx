    ...
    return(
        <Box>
            <Typography variant="h4" sx={{ marginBottom: 2 }}>
                Using light beams instead of electricity to perform computations
            </Typography>
            ...
            <Typography variant="body1" gutterBottom>
                <b>Photonic (Light-Based) Computing</b>: A key breakthrough could involve chips that <b>use light beams instead of 
                electricity to perform computations</b>. For instance, engineers have developed programmable photonic chips 
