    ...
    return(
        <Box>
            <Typography variant="h4" sx={{ marginBottom: 2 }}>
                Modulation of beam's behavior in photonic compute
            </Typography>
            ...
            <Typography variant="body1" gutterBottom>
                ...
                material where a "pump" beam <b>modulates</b> a "signal" <b>beam's behavior</b> (absorption, transmission, or amplification), 
