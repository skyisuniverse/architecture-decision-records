    ...
    return(
        <Box>
            <Typography variant="h4" sx={{ marginBottom: 2 }}>
                Training nonlinear neural networks with Photonic chips
            </Typography>
            ...
            <Typography variant="body1" gutterBottom>
                ...
                electricity to perform computations. For instance, engineers have developed programmable <b>photonic 
                chips</b> capable of <b>training nonlinear neural networks</b> directly with light. This works by using a semiconductor 
