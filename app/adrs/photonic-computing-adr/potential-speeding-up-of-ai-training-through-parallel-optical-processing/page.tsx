    ...
    return(
        <Box>
            <Typography variant="h4" sx={{ marginBottom: 2 }}>
                Potential speeding up of AI training through parallel optical processing
            </Typography>
            ...
            <Typography variant="body1" gutterBottom>
                ...
                than electronic equivalents — <b>potentially</b> reducing AI data center power consumption by orders of magnitude 
                and <b>speeding up training through parallel optical processing</b>. This could make training easier by eliminating 
