    ...
    return(
        <Box>
            <Typography variant="h4" sx={{ marginBottom: 2 }}>
                Real-time reconfiguration and nonlinear functions essential for deep learning
            </Typography>
            ...
            <Typography variant="body1" gutterBottom>
                ...
                enabling <b>real-time reconfiguration and nonlinear functions essential for deep learning</b>. Such chips have 
