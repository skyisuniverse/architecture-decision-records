    ...
    return(
        <Box>
            <Typography variant="h4" sx={{ marginBottom: 2 }}>
                Eliminating heat management issues for AI training with Photonic compute
            </Typography>
            ...
            <Typography variant="body1" gutterBottom>
                ...
                than electronic equivalents—potentially reducing <b>AI</b> data center power consumption by orders of magnitude 
                and speeding up training through parallel optical processing. This could make <b>training</b> easier by 
                eliminating <b>heat management issues</b> and enabling scalable, low-power systems.
            </Typography>
        </Box>
    )
}