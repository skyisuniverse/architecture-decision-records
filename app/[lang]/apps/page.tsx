...
export default function ServicesPage() {   // ← kept original name (copy-paste remnant)
  ...
  // Helper to make any internal link locale-aware (consistent with all other pages)
