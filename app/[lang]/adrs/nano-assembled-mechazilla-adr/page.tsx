...
export default async function Page({ params }: { params: Promise<{ lang: Locale }> }) {
  ...
  return (
    <ADRCategoryPage
      title={globalDict['nano-assembled-mechazilla-adr'] ?? 'Nano-Assembled Mechazilla ADR'}
      publishedDate={globalDict['nano-assembled-mechazilla-adr.published'] ?? 'Published April 2026'}
      description={<></>}
