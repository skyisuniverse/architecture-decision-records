...
export default async function Page({ params }: { params: Promise<{ lang: Locale }> }) {
  ...
  return (
    <ADRCategoryPage
      title={globalDict['nano-assembled-optimus-adr'] ?? 'Nano Assembled Optimus ADR'}
      publishedDate={globalDict['nano-assembled-optimus-adr.published'] ?? 'Published April 2026'}
      description={<></>}
