...
export default async function Page({ params }: { params: Promise<{ lang: Locale }> }) {
  ...
  return (
    <ADRCategoryPage
      title={globalDict['faster-factories-with-optimus-semi-cybercab-adr'] ?? '80%-Faster 60%-Cheaper Factories With Optimus Semi Cybercab ADR'}
      publishedDate={globalDict['faster-factories-with-optimus-semi-cybercab-adr.published'] ?? 'Published April 2026'}
      description={<></>}
