...
export default async function Page({ params }: { params: Promise<{ lang: Locale }> }) {
  ...
  return (
    <ADRCategoryPage
      title={globalDict['instantly-reusable-launchpad-adr'] ?? 'Instantly Reusable Launchpad ADR'}
      publishedDate={globalDict['instantly-reusable-launchpad-adr.published'] ?? 'Published April 2026'}
      description={<></>}
