...
export default async function Page({ params }: { params: Promise<{ lang: Locale }> }) {
  ...
  return (
    <ADRCategoryPage
      title={globalDict['xai-powered-entirely-with-solar-adr'] ?? 'xAI powered entirely with solar ADR'}
      publishedDate={globalDict['xai-powered-entirely-with-solar-adr.published'] ?? 'Published April 2026'}
      description={<></>}
