...
import { ComputerAdrsList } from "./computer-adrs-list";
...
export default async function Page({
  ...
  return (
    <ADRCategoryPage
      title={globalDict["computer-adr"] ?? "Computer ADR"}
      publishedDate={
        globalDict["3d-printer-adr.published"] ?? "Published April 2026"
      }
      description={<></>}
      adrsList={ComputerAdrsList}
