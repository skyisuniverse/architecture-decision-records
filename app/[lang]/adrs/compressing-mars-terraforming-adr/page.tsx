...
export default async function Page({ params }: { params: Promise<{ lang: Locale }> }) {
  ...
  return (
    <ADRCategoryPage
      title={globalDict['compressing-mars-terraforming-adr'] ?? 'Compressing Mars Terraforming from 100,000+ to 10 years'}
      publishedDate={globalDict['compressing-mars-terraforming-adr.published'] ?? 'Published April 2026'}
      description={<></>}
